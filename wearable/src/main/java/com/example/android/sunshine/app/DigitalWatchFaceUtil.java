...
public final class DigitalWatchFaceUtil {
    ...
    public static final String COLOR_NAME_DEFAULT_AND_AMBIENT_HIGH_TEMPERATURE = "White";
    public static final int COLOR_VALUE_DEFAULT_AND_AMBIENT_HIGH_TEMPERATURE =
            parseColor(COLOR_NAME_DEFAULT_AND_AMBIENT_HIGH_TEMPERATURE);

    public static final String COLOR_NAME_DEFAULT_AND_AMBIENT_LOW_TEMPERATURE = "White";
    public static final int COLOR_VALUE_DEFAULT_AND_AMBIENT_LOW_TEMPERATURE =
            parseColor(COLOR_NAME_DEFAULT_AND_AMBIENT_LOW_TEMPERATURE);
