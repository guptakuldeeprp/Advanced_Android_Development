...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    /**
     * Class to asynchronously send weather updates to all connected wearables
     */
    private class WearableMessageSender extends Thread {

        private String message;
        private String path;

        public WearableMessageSender() {

        }

        public WearableMessageSender(String message, String path) {
        ...
        public void run() {
            if (mGoogleApiClient.isConnected()) {
                ...
                if (nodes.getNodes() != null && nodes.getNodes().size() > 0) {
                    Log.i(LOG_TAG, "Connected Nodes found. Sending message to wearable");
                    ...
                    Log.i(LOG_TAG, "No connected Nodes found.");
                }
            }
        }
    ...
    private String prepareWearableMessage(Object... parts) {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                // Only for today's forecast
                if (i == 0) {
                    String lowStr = Utility.formatTemperature(getContext(), low);
                    String highStr = Utility.formatTemperature(getContext(), high);
                    String newMessageString = prepareWearableMessage(lowStr, highStr, weatherId);
